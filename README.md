...
1. 제목
    - [ ] 제목을 작성중 모든 문구를 지웠을 때 에러 문구가 표시된다.

2. 태그
    - [ ] 글과 글 사이는 쉼표로 구분되고 공백이 있을 경우 에러 문구가 표시된다.
    - [ ] 쉼표로 구분된 문자열이 5자 초과일 경우 에러 문구가 표시된다.
    - [ ]  쉼표로 구분된 개수가 5개 초과일 경우 에러 문구가 표시된다.

3. 생성 버튼
    - [ ] 제목과 태그에 오류가 없고 제목이 공백이 아닐 경우 활성화된다.
    - [ ] 제목 에러 발생시 비활성화된다.
    - [ ] 태그 에러 발생시 비활성화된다.